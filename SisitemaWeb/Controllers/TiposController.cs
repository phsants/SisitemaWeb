...
namespace SistemaWeb.Controllers
{
    ...
    public class TiposController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Metodospagamento")] Tipo tipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Metodospagamento")] Tipo tipo)
        {
            if (id != tipo.Id)
            {
                return NotFound();
